...
\item  %PROBLEM 2a
  ...
  Using simple geometry (small angle approximation), a distance of 9.4 Mpc and a pixel scale of 1:1", I estimate the physical scale length as:\\
  
  \hspace{10mm} h[kpc] = $9400 [kpc] \cdot \frac{h["]}{3600} \cdot \frac{\pi}{180}$ \\
  ...
  \hspace{10mm} $\Sigma \ = 10^{0.4(26.4- \mu)} L_{\odot} pc^{-2}$
   ...
   \item Surface Brightness Distance Invariance \\%3e
